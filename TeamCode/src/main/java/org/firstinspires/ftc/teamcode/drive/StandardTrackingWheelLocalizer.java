...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 5.156098199804742; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 6.375; // in; offset of the lateral wheel


    public static double X_MULTIPLIER = 1.01206987911;
    public static double Y_MULTIPLIER = 1.00935789803;
